...
module mkITCM(verbosity,
  ...
  wire [14 : 0] itcm$ADDRA, itcm$ADDRB;
  ...
  wire [31 : 0] a_out_araddr__h6161,
		...
		y__h6268,
		y__h6269;
  wire [7 : 0] x__h5458, x__h5965, x__h6452, x__h6671;
  ...
  // register deburstr_rg_last_beat_raddr
  assign deburstr_rg_last_beat_raddr$D_IN = a_out_araddr__h6161 ;
  assign deburstr_rg_last_beat_raddr$EN =
	     CAN_FIRE_RL_deburstr_rl_rd_xaction_master_to_slave ;

  // register deburstr_rg_last_beat_waddr
  assign deburstr_rg_last_beat_waddr$D_IN = a_out_awaddr__h5077 ;
  ...
  // submodule itcm
  assign itcm$ADDRA = w_imem_req$wget[19:5] ;
  assign itcm$ADDRB =
	     WILL_FIRE_RL_dma_port_rl_dma_wr_req ?
  ...
  assign addr___1__h6255 = x__h6267 | y__h6268 ;
  assign addr__h5159 =
  ...
  assign wrap_mask__h5161 =
	     (burst_len__h5160 <<
	      deburstr_xactor_from_master_f_wr_addr$D_OUT[20:18]) -
	     32'd1 ;
  assign wrap_mask__h6245 =
	     (burst_len__h6244 <<
	      deburstr_xactor_from_master_f_rd_addr$D_OUT[20:18]) -
	     32'd1 ;
  assign x__h5183 = deburstr_rg_last_beat_waddr & y__h5185 ;
  assign x__h5458 = deburstr_rg_w_beat_count + 8'd1 ;
  assign x__h5965 = deburstr_rg_b_beat_count + 8'd1 ;
  assign x__h6267 = deburstr_rg_last_beat_raddr & y__h6269 ;
  assign x__h6452 = deburstr_rg_ar_beat_count + 8'd1 ;
  assign x__h6671 = deburstr_rg_r_beat_count + 8'd1 ;
  assign y__h5184 = addr__h5159 & wrap_mask__h5161 ;
  assign y__h5185 = ~wrap_mask__h5161 ;
  assign y__h6268 = addr__h6243 & wrap_mask__h6245 ;
  assign y__h6269 = ~wrap_mask__h6245 ;
  ...
  begin
    ...
    v__h2312 = v__h2318 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_dma_rd_rsp && NOT_verbosity_ULE_1_2___d23)
	$display("%0d: %m.rl_dma_rd_rsp", v__h2312);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_dma_rd_rsp && NOT_verbosity_ULE_1_2___d23)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2635 = v__h2641 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_bad_wr_addr && verbosity != 2'd0)
	$display("%0d: %m.rl_bad_wr_addr", v__h2635);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_bad_wr_addr && verbosity != 2'd0)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2092 = v__h2098 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_dma_rd_req && NOT_verbosity_ULE_1_2___d23)
	$display("%0d: %m.rl_dma_rd_req", v__h2092);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_dma_rd_req && NOT_verbosity_ULE_1_2___d23)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_dma_wr_req && NOT_verbosity_ULE_1_2___d23)
	$display("%0d: %m.rl_dma_wr_req", v__h2942);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dma_port_rl_dma_wr_req && NOT_verbosity_ULE_1_2___d23)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8729 = v__h8735 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_reset && NOT_verbosity_ULE_1_2___d23)
	$display("%0d: %m.reset", v__h8729);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_reset && NOT_verbosity_ULE_1_2___d23)
	begin
	  v__h8828 = $stime;
    ...
    v__h8822 = v__h8828 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_reset && NOT_verbosity_ULE_1_2___d23)
	$display("%0d: %m.reset", v__h8822);
    if (RST_N != `BSV_RESET_VALUE)
