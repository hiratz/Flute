...
module mkCore(CLK,
  ...
  // ports of submodule dm_gpr_tap
  wire [234 : 0] dm_gpr_tap$trace_data_out_get;
  wire [37 : 0] dm_gpr_tap$client_request_get, dm_gpr_tap$server_request_put;
  wire [32 : 0] dm_gpr_tap$client_response_put,
		dm_gpr_tap$server_response_get;
  wire dm_gpr_tap$EN_client_request_get,
       dm_gpr_tap$EN_client_response_put,
       dm_gpr_tap$EN_server_request_put,
       dm_gpr_tap$EN_server_response_get,
       dm_gpr_tap$EN_trace_data_out_get,
       dm_gpr_tap$RDY_client_request_get,
       dm_gpr_tap$RDY_client_response_put,
       dm_gpr_tap$RDY_server_request_put,
       dm_gpr_tap$RDY_server_response_get,
       dm_gpr_tap$RDY_trace_data_out_get;

  // ports of submodule dm_mem_tap
  wire [234 : 0] dm_mem_tap$trace_data_out_get;
  wire [31 : 0] dm_mem_tap$master_araddr,
  ...
  wire [44 : 0] MUX_dm_csr_tap$server_request_put_1__VAL_1,
		MUX_dm_csr_tap$server_request_put_1__VAL_2;
  ...
  wire [37 : 0] MUX_dm_gpr_tap$server_request_put_1__VAL_1,
		MUX_dm_gpr_tap$server_request_put_1__VAL_2;
  ...
  wire MUX_clint$server_reset_request_put_1__SEL_1,
       MUX_dm_csr_tap$server_request_put_1__SEL_1,
       MUX_dm_gpr_tap$server_request_put_1__SEL_1,
  ...
  reg IF_dm_stub_input_Xactor_f_rd_addr_first__4_BIT_ETC___d84,
      IF_dm_stub_input_Xactor_f_wr_addr_first__43_BI_ETC___d153;
  wire [31 : 0] x_rdata__h8548, x_rdata__h8598;
  ...
  // submodule dm_gpr_tap
  mkDM_GPR_Tap dm_gpr_tap(.CLK(CLK),
			  .RST_N(RST_N),
			  .client_response_put(dm_gpr_tap$client_response_put),
			  .server_request_put(dm_gpr_tap$server_request_put),
			  .EN_client_request_get(dm_gpr_tap$EN_client_request_get),
			  .EN_client_response_put(dm_gpr_tap$EN_client_response_put),
			  .EN_server_request_put(dm_gpr_tap$EN_server_request_put),
			  .EN_server_response_get(dm_gpr_tap$EN_server_response_get),
			  .EN_trace_data_out_get(dm_gpr_tap$EN_trace_data_out_get),
			  .client_request_get(dm_gpr_tap$client_request_get),
			  .RDY_client_request_get(dm_gpr_tap$RDY_client_request_get),
			  .RDY_client_response_put(dm_gpr_tap$RDY_client_response_put),
			  .RDY_server_request_put(dm_gpr_tap$RDY_server_request_put),
			  .server_response_get(dm_gpr_tap$server_response_get),
			  .RDY_server_response_get(dm_gpr_tap$RDY_server_response_get),
			  .trace_data_out_get(dm_gpr_tap$trace_data_out_get),
			  .RDY_trace_data_out_get(dm_gpr_tap$RDY_trace_data_out_get));
  ...
  FIFO2 #(.width(32'd235), .guarded(1'd1)) f_trace_data_merged(.RST(RST_N),
							       .CLK(CLK),
  ...
  assign CAN_FIRE_RL_merge_dm_gpr_trace_data =
	     dm_gpr_tap$RDY_trace_data_out_get && f_trace_data_merged$FULL_N ;
  ...
  assign CAN_FIRE_RL_dm_stub_read_req_rl =
	     dm_stub_input_Xactor_f_rd_addr$EMPTY_N &&
	     IF_dm_stub_input_Xactor_f_rd_addr_first__4_BIT_ETC___d84 ;
  ...
  assign MUX_dm_csr_tap$server_request_put_1__SEL_1 =
	     WILL_FIRE_RL_dm_stub_read_req_rl &&
	     dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61] == 4'd4 ;
  assign MUX_dm_gpr_tap$server_request_put_1__SEL_1 =
	     WILL_FIRE_RL_dm_stub_read_req_rl &&
  ...
  assign dm_csr_tap$server_request_put =
	     MUX_dm_csr_tap$server_request_put_1__SEL_1 ?
	       MUX_dm_csr_tap$server_request_put_1__VAL_1 :
	       MUX_dm_csr_tap$server_request_put_1__VAL_2 ;
  ...
  // submodule dm_gpr_tap
  assign dm_gpr_tap$client_response_put =
	     cpu$debug_hart_gpr_mem_server_response_get ;
  assign dm_gpr_tap$server_request_put =
	     MUX_dm_gpr_tap$server_request_put_1__SEL_1 ?
	       MUX_dm_gpr_tap$server_request_put_1__VAL_1 :
	       MUX_dm_gpr_tap$server_request_put_1__VAL_2 ;
  assign dm_gpr_tap$EN_client_request_get = CAN_FIRE_RL_ClientServerRequest ;
  assign dm_gpr_tap$EN_client_response_put =
	     CAN_FIRE_RL_ClientServerResponse ;
  assign dm_gpr_tap$EN_server_request_put =
	     WILL_FIRE_RL_dm_stub_read_req_rl &&
	     dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61] == 4'd3 ||
	     WILL_FIRE_RL_dm_stub_write_req_rl &&
	     dm_stub_input_Xactor_f_wr_addr$D_OUT[64:61] == 4'd3 ;
  assign dm_gpr_tap$EN_server_response_get =
	     WILL_FIRE_RL_dm_stub_gpr_wr_rsp_rl ||
	     WILL_FIRE_RL_dm_stub_gpr_rd_rsp_rl ;
  assign dm_gpr_tap$EN_trace_data_out_get =
	     CAN_FIRE_RL_merge_dm_gpr_trace_data ;

  // submodule dm_mem_tap
  assign dm_mem_tap$master_arready = local_fabric$v_from_masters_1_arready ;
  assign dm_mem_tap$master_awready = local_fabric$v_from_masters_1_awready ;
  assign dm_mem_tap$master_bid = local_fabric$v_from_masters_1_bid ;
  assign dm_mem_tap$master_bresp = local_fabric$v_from_masters_1_bresp ;
  assign dm_mem_tap$master_bvalid = local_fabric$v_from_masters_1_bvalid ;
  assign dm_mem_tap$master_rdata = local_fabric$v_from_masters_1_rdata ;
  assign dm_mem_tap$master_rid = local_fabric$v_from_masters_1_rid ;
  assign dm_mem_tap$master_rlast = local_fabric$v_from_masters_1_rlast ;
  assign dm_mem_tap$master_rresp = local_fabric$v_from_masters_1_rresp ;
  assign dm_mem_tap$master_rvalid = local_fabric$v_from_masters_1_rvalid ;
  assign dm_mem_tap$master_wready = local_fabric$v_from_masters_1_wready ;
  assign dm_mem_tap$slave_araddr =
	     { dm_stub_sbus_master_f_rd_addr$D_OUT[60:31], 2'd0 } ;
  assign dm_mem_tap$slave_arburst =
	     dm_stub_sbus_master_f_rd_addr$D_OUT[17:16] ;
  assign dm_mem_tap$slave_arcache =
	     dm_stub_sbus_master_f_rd_addr$D_OUT[14:11] ;
  assign dm_mem_tap$slave_arid = dm_stub_sbus_master_f_rd_addr$D_OUT[64:61] ;
  assign dm_mem_tap$slave_arlen = dm_stub_sbus_master_f_rd_addr$D_OUT[28:21] ;
  assign dm_mem_tap$slave_arlock = dm_stub_sbus_master_f_rd_addr$D_OUT[15] ;
  assign dm_mem_tap$slave_arprot = dm_stub_sbus_master_f_rd_addr$D_OUT[10:8] ;
  assign dm_mem_tap$slave_arqos = dm_stub_sbus_master_f_rd_addr$D_OUT[7:4] ;
  assign dm_mem_tap$slave_arregion =
	     dm_stub_sbus_master_f_rd_addr$D_OUT[3:0] ;
  assign dm_mem_tap$slave_arsize = 3'd2 ;
  assign dm_mem_tap$slave_arvalid = dm_stub_sbus_master_f_rd_addr$EMPTY_N ;
  assign dm_mem_tap$slave_awaddr =
	     { dm_stub_sbus_master_f_wr_addr$D_OUT[60:31], 2'd0 } ;
  assign dm_mem_tap$slave_awburst =
	     dm_stub_sbus_master_f_wr_addr$D_OUT[17:16] ;
  assign dm_mem_tap$slave_awcache =
	     dm_stub_sbus_master_f_wr_addr$D_OUT[14:11] ;
  assign dm_mem_tap$slave_awid = dm_stub_sbus_master_f_wr_addr$D_OUT[64:61] ;
  assign dm_mem_tap$slave_awlen = dm_stub_sbus_master_f_wr_addr$D_OUT[28:21] ;
  assign dm_mem_tap$slave_awlock = dm_stub_sbus_master_f_wr_addr$D_OUT[15] ;
  assign dm_mem_tap$slave_awprot = dm_stub_sbus_master_f_wr_addr$D_OUT[10:8] ;
  assign dm_mem_tap$slave_awqos = dm_stub_sbus_master_f_wr_addr$D_OUT[7:4] ;
  assign dm_mem_tap$slave_awregion =
	     dm_stub_sbus_master_f_wr_addr$D_OUT[3:0] ;
  assign dm_mem_tap$slave_awsize = 3'd2 ;
  assign dm_mem_tap$slave_awvalid = dm_stub_sbus_master_f_wr_addr$EMPTY_N ;
  assign dm_mem_tap$slave_bready = dm_stub_sbus_master_f_wr_resp$FULL_N ;
  assign dm_mem_tap$slave_rready = dm_stub_sbus_master_f_rd_data$FULL_N ;
  assign dm_mem_tap$slave_wdata = dm_stub_sbus_master_f_wr_data$D_OUT[36:5] ;
  assign dm_mem_tap$slave_wlast = dm_stub_sbus_master_f_wr_data$D_OUT[0] ;
  assign dm_mem_tap$slave_wstrb = dm_stub_sbus_master_f_wr_data$D_OUT[4:1] ;
  assign dm_mem_tap$slave_wvalid = dm_stub_sbus_master_f_wr_data$EMPTY_N ;
  ...
  assign dm_stub_sbus_master_f_rd_data$ENQ =
	     dm_mem_tap$slave_rvalid && dm_stub_sbus_master_f_rd_data$FULL_N ;
  ...
  assign dm_stub_sbus_master_f_wr_resp$D_IN =
	     { dm_mem_tap$slave_bid, dm_mem_tap$slave_bresp } ;
  assign dm_stub_sbus_master_f_wr_resp$ENQ =
	     dm_mem_tap$slave_bvalid && dm_stub_sbus_master_f_wr_resp$FULL_N ;
  ...
  always@(WILL_FIRE_RL_merge_cpu_trace_data or
	  ...
	  dm_gpr_tap$trace_data_out_get or
	  WILL_FIRE_RL_merge_dm_csr_trace_data or
	  dm_csr_tap$trace_data_out_get or
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      WILL_FIRE_RL_merge_dm_gpr_trace_data:
	  f_trace_data_merged$D_IN = dm_gpr_tap$trace_data_out_get;
      WILL_FIRE_RL_merge_dm_csr_trace_data:
  ...
  assign local_fabric$v_from_masters_1_araddr = dm_mem_tap$master_araddr ;
  assign local_fabric$v_from_masters_1_arburst = dm_mem_tap$master_arburst ;
  assign local_fabric$v_from_masters_1_arcache = dm_mem_tap$master_arcache ;
  assign local_fabric$v_from_masters_1_arid = dm_mem_tap$master_arid ;
  assign local_fabric$v_from_masters_1_arlen = dm_mem_tap$master_arlen ;
  assign local_fabric$v_from_masters_1_arlock = dm_mem_tap$master_arlock ;
  assign local_fabric$v_from_masters_1_arprot = dm_mem_tap$master_arprot ;
  assign local_fabric$v_from_masters_1_arqos = dm_mem_tap$master_arqos ;
  assign local_fabric$v_from_masters_1_arregion = dm_mem_tap$master_arregion ;
  assign local_fabric$v_from_masters_1_arsize = dm_mem_tap$master_arsize ;
  assign local_fabric$v_from_masters_1_arvalid = dm_mem_tap$master_arvalid ;
  assign local_fabric$v_from_masters_1_awaddr = dm_mem_tap$master_awaddr ;
  assign local_fabric$v_from_masters_1_awburst = dm_mem_tap$master_awburst ;
  assign local_fabric$v_from_masters_1_awcache = dm_mem_tap$master_awcache ;
  assign local_fabric$v_from_masters_1_awid = dm_mem_tap$master_awid ;
  assign local_fabric$v_from_masters_1_awlen = dm_mem_tap$master_awlen ;
  assign local_fabric$v_from_masters_1_awlock = dm_mem_tap$master_awlock ;
  assign local_fabric$v_from_masters_1_awprot = dm_mem_tap$master_awprot ;
  assign local_fabric$v_from_masters_1_awqos = dm_mem_tap$master_awqos ;
  assign local_fabric$v_from_masters_1_awregion = dm_mem_tap$master_awregion ;
  assign local_fabric$v_from_masters_1_awsize = dm_mem_tap$master_awsize ;
  assign local_fabric$v_from_masters_1_awvalid = dm_mem_tap$master_awvalid ;
  assign local_fabric$v_from_masters_1_bready = dm_mem_tap$master_bready ;
  assign local_fabric$v_from_masters_1_rready = dm_mem_tap$master_rready ;
  assign local_fabric$v_from_masters_1_wdata = dm_mem_tap$master_wdata ;
  assign local_fabric$v_from_masters_1_wlast = dm_mem_tap$master_wlast ;
  assign local_fabric$v_from_masters_1_wstrb = dm_mem_tap$master_wstrb ;
  assign local_fabric$v_from_masters_1_wvalid = dm_mem_tap$master_wvalid ;
  ...
  begin
    case (dm_stub_input_Xactor_f_wr_addr$D_OUT[64:61])
	  ...
	  IF_dm_stub_input_Xactor_f_wr_addr_first__43_BI_ETC___d153 =
	      dm_gpr_tap$RDY_server_request_put;
      default: IF_dm_stub_input_Xactor_f_wr_addr_first__43_BI_ETC___d153 =
		   dm_stub_input_Xactor_f_wr_addr$D_OUT[64:61] != 4'd4 ||
		   dm_csr_tap$RDY_server_request_put;
    endcase
  end
  ...
  begin
    case (dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61])
	  ...
	  IF_dm_stub_input_Xactor_f_rd_addr_first__4_BIT_ETC___d84 =
	      dm_gpr_tap$RDY_server_request_put;
      default: IF_dm_stub_input_Xactor_f_rd_addr_first__4_BIT_ETC___d84 =
		   dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61] != 4'd4 ||
		   dm_csr_tap$RDY_server_request_put;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h5364);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5599 = v__h5605 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h5599);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8490 = v__h8496 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dm_stub_reset_rsp_rl)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h8490);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h7955 = v__h7961 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dm_stub_read_req_rl &&
	  dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61] == 4'd1)
	$display("%0d: Core.rl_cpu_hart0_reset_from_dm_start", v__h7955);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_dm_stub_read_req_rl &&
	  dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61] != 4'd0 &&
	  dm_stub_input_Xactor_f_rd_addr$D_OUT[64:61] != 4'd1 &&
