...
module mkJtagTap(CLK,
  ...
  reg [39 : 0] CASE_newir199_0_1_1_2147483648_0x10_2147483648_ETC__q1,
	       v__h2040;
  ...
  wire r_state_EQ_8_0_AND_r_ir_EQ_0x10_0_AND_r_dr_6_B_ETC___d55,
       r_state_EQ_8_0_AND_r_ir_EQ_0x11_2_AND_NOT_r_dm_ETC___d66,
       r_state_EQ_8_0_AND_r_ir_EQ_0x11_2_AND_NOT_r_dm_ETC___d70;
  ...
  assign CAN_FIRE_RL_dmi_reset =
	     r_state_EQ_8_0_AND_r_ir_EQ_0x10_0_AND_r_dr_6_B_ETC___d55 &&
  ...
  assign r_drmask$D_IN =
	     (r_state == 4'd3) ?
	       CASE_newir199_0_1_1_2147483648_0x10_2147483648_ETC__q1 :
	       r_drmask ;
  ...
  assign IF_r_dmistat_busy_port0__read__38_OR_NOT_r_dmi_ETC___d141 =
	     (r_dmistat_busy ||
	      ...
	      f_dmi_busy$EMPTY_N) ?
	       40'hAAAAAAAAAB :
	       r_dmi ;
  assign r_state_EQ_8_0_AND_r_ir_EQ_0x10_0_AND_r_dr_6_B_ETC___d55 =
	     r_state == 4'd8 && r_ir == 5'h10 && (r_dr[17] || r_dr[16]) ;
  assign r_state_EQ_8_0_AND_r_ir_EQ_0x11_2_AND_NOT_r_dm_ETC___d66 =
	     r_state == 4'd8 && r_ir == 5'h11 && r_dmi[1:0] != 2'd2 &&
	     r_dmi[1:0] != 2'd3 &&
	     f_dmi_busy$EMPTY_N ;
  assign r_state_EQ_8_0_AND_r_ir_EQ_0x11_2_AND_NOT_r_dm_ETC___d70 =
	     r_state == 4'd8 && r_ir == 5'h11 && r_dmi[1:0] != 2'd2 &&
	     r_dmi[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  ...
  begin
    case (newir__h3199)
	  ...
	  CASE_newir199_0_1_1_2147483648_0x10_2147483648_ETC__q1 = 40'd1;
      5'd1, 5'h10:
	  CASE_newir199_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
	      40'h0080000000;
      5'h11:
	  CASE_newir199_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
	      40'h8000000000;
      default: CASE_newir199_0_1_1_2147483648_0x10_2147483648_ETC__q1 =
		   40'h0100000000;
    endcase
  end
  always@(r_state)
